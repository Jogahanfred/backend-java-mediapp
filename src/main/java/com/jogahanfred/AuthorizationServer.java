...
//Tercera Clase.- Generacion del Token
@Configuration
...
public class AuthorizationServer extends AuthorizationServerConfigurerAdapter{
	...
	/*
	@Autowired
	private ITokenService tokenService; Aqui traemos la tabla en la que se encuentra el token  */
	...
	public void configure(ClientDetailsServiceConfigurer configurer) throws Exception {
		...
		//Tiempo de expiracion tokenService.getTokentime
